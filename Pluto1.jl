...
# ╔═╡ 8fe8bb60-239b-11ec-1f2f-754a591f6bc4
begin
	using Pkg
	using DifferentialEquations,Plots
end 

# ╔═╡ b779259b-418f-45f5-a6f8-dc7456604e4e
begin
	C₁ = 5.730
	u₀ = 1.0
	tspan = (0.0, 30.0)
...
# ╔═╡ cc9304b9-761f-46ab-b580-fe9f4cc1002e
begin
	...
	plot!(sol.t, t->exp(-log(2) / C₁*t), lw=3, ls=:dash, label="Analytical Solution")
end

# ╔═╡ 16fc3bdb-aa4d-4a3b-9086-463417712c58
begin
	const g = 9.81
	const L = 1.0
	u1 = [0,π/2]
...
# ╔═╡ 4ca34642-6781-4276-9c40-eb20eb92da92
...
# ╔═╡ 340850a4-f474-48e3-bc09-1badebbf9dae
begin
	prob1 = ODEProblem(simplependulum,u1, tspan1)
	sol1 = solve(prob,Tsit5())
end

# ╔═╡ d7e78211-9e1c-424b-bf44-c0765b2942a6
begin
	plot(sol1,linewidth=2,
...
git-tree-sha1 = "9a7891db5717e4260cf285a252c7b61d948dcf83"
...
git-tree-sha1 = "2751ce2fa8fcd0bf7c9dd9f3b0d1ea53698a272d"
