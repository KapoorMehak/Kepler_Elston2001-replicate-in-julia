...
# ╔═╡ a07083b0-255c-11ec-0263-edb4d00eace7
using DifferentialEquations,Plots

# ╔═╡ ee4d5bb4-aec1-40b2-aeb3-9b347f76ad40
begin
	s1=2
	s2=6
	s3=1
...
# ╔═╡ e7fb7bf8-619a-4074-b8e4-b955718bc3da
function Metabolic(a3,k1,k2,k3,k4)
	v1=k1
	v2=k2.*s1
	v3=k3.*s3
	v4=k4.*s2.*a3
	
	return d1=v1-v2;d2=v2-v3-v4;d3=v2+v4
end

# ╔═╡ e5608505-9c2a-47fa-a12c-48fe14be4810
begin
	prob= ODEProblem(Metabolic)
	sol= solve(prob)
end

# ╔═╡ cf680e6b-102d-4b1f-bfb9-298dc6268ef0
sol2= Metabolic(1,1,2,3,4)
...
git-tree-sha1 = "e1ce2a8fc2dd344070a2fb7522753a70fab5a72f"
